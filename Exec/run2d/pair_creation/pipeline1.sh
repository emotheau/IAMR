...
COARSEDIR='/project/projectdirs/dasrepo/jpathak/iamr_expts/kolmogorov/processed_files/256/'$idx'/coarse'
...
PLOTDIR='/project/projectdirs/dasrepo/jpathak/iamr_expts/kolmogorov/processed_files/256/'$idx'/plots'
...
$EXECDIR/amr2d.gnu.haswell.MPI.ex $INPUTDIR/inputs.2d.KolmogorovPairs amr.restart="$COARSEDIR/coarse_${filename##*/}" amr.plotfile_on_restart=0 stop_interval=0.1 amr.n_cell=128 128 amr.check_file="$TIMESTEPDIR/tilde_${filename##*/}_" amr.plot_int=10000000 
