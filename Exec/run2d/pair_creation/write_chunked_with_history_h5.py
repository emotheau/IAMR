...
h5dir = '/global/cscratch1/sd/jpathak/iamr_training_pairs/kolmogorov/256/h5_with_history/'

if ii == 0:
    if not os.path.exists(h5dir):
        os.makedirs(h5dir)

train_file = os.path.join(h5dir, 'training_pairs_h1' + str(ii)+ '_' + str(idx) +  '.h5')
