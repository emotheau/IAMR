...
$EXECDIR/amr2d.gnu.haswell.MPI.ex $INPUTDIR/inputs.2d.KolmogorovPairs amr.restart="$COARSEDIR/coarse_${filename##*/}" stop_interval=0.1 amr.n_cell=128 128 amr.check_file="$TIMESTEPDIR/tilde_${filename##*/}_" 
