...
X_dict = csv_to_dict("X_dict_"+ str(res) +  "_ur" + str(user_ratio) + str(idx) + ".csv")
X_tilde_dict = csv_to_dict( "X_tilde_dict_"+ str(res) +  "_ur" + str(user_ratio) + str(idx) + ".csv" )
X_tilde_lr_dir = csv_to_dict( "X_tilde_lr_dict_" + str(res) +  "_ur" + str(user_ratio) + str(idx) + ".csv") 
...
X_tilde_lr_dir = basedir + '/lr_plots'
h5dir = '/global/cscratch1/sd/jpathak/iamr_training_pairs/kolmogorov/'+ str(res) + '/ur' + str(user_ratio) + '/h5_with_history/'
