...
srun -n 64 amr3d.gnu.haswell.MPI.ex inputs.3d.HIT prob.inres=$res prob.iname=$iname amr.n_cell=$res $res $res amr.plot_file=$plot_file amr.check_file=$check_file amr.v=$verbose ns.v=$verbose
