...
filename='/global/cscratch1/sd/jpathak/iamr_hit/128/checkpoints/chk_00475'
echo $filename
...
##wait
#
$EXECDIR/amr3d.gnu.haswell.MPI.ex $INPUTDIR/inputs.3d.HIT amr.restart="$COARSEDIR/coarse_${filename##*/}" amr.plotfile_on_restart=-1 stop_interval=0.1 amr.check_per=0.1 amr.n_cell=$l_res $l_res $l_res amr.check_file="$TIMESTEPDIR/tilde_${filename##*/}_" amr.plot_int=10000000 amr.plot_file="plotfiles/" 
#
